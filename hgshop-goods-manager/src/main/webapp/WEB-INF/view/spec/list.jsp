        	...
        	<form id="addspec">
        		 <div class="form-group">
  				...
  				<div class="form-group">
    				...
    				<input type="text" name="options[0].optionName" class="form-control" id="inputAddress" placeholder="填写属性值">
...
<table class="table">
	...
	<tr class="text-align:center">
		<td colspan="10">
				<button name="page" class="btn btn-dark">首页</button>		
				<button name="page" class="btn btn-dark">上一页</button>		
				<button name="page" class="btn btn-dark">下一页</button>		
				<button name="page" class="btn btn-dark">尾页</button>		
		</td>
	</tr>
...
<script type="text/javascript">
	...
	function addProp(){
		$("#addspec").append('<div class="form-group">'+
    				'<label for="inputAddress">属性值</label>'+
    				'<input type="text" name="options['+addindex+'].optionName" class="form-control" id="inputAddress" placeholder="填写属性值">'+
